		...
		<div className='pt-32'>
				...
				<Pdf targetRef={ref} filename='Blogs.pdf'>
					{({ toPdf }) => (
						<button
							onClick={toPdf}
							className='bg-red-300 px-5 py-2  font-bold text-black rounded-lg tracking-wide hover:bg-red-500 hover:text-lg ease-in-out duration-300'>
							Download Blog Page
						</button>
					)}
				</Pdf>
			...
			<div ref= {ref} >
				...
				<div className='collapse-content bg-red-200 md:mx-36 mx-4 my-8 rounded-lg'>
				...
				<div className='collapse-content bg-red-200 md:mx-36 mx-4 my-8 rounded-lg'>
					...
					<p className='text-base font-medium p-10'>
						...
						unexpected errors in your app. <br /> <br />
